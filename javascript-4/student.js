...
// CODE HERE
let favColors = ['yellow', 'blue', 'gold']
...
let me = {
    firstName: 'Nolan',
    superHeroName: 'Human joy-stick',
    homeTown: 'Albany',
    superPowers: 'speedster',
...
//  and it should receive its value from the value of your firstName key on the me object above. The next variable is 'superName'
//  which should have its value assigned as the value of the superHeroName property on the me object.
...
function setColor(arr){
    ...
    background(yellow, blue, green)
}


//////////////////Step 5////////////////////
//Create a function called 'setPowers' that takes in 'arr' as a parameter. In your setPowers function, loop over the arr parameter and run a function
//  we created called createLi(), which will take each item of the array as an argument. Remember, you did not create the createLi function.
...
//////////////////Step 6////////////////////
//Lastly, create a function called 'redactInfo' that will take in an object called 'obj' as a parameter. Now,
//  imagine your super hero needs to go undercover, and you need to remove all info about them. 
