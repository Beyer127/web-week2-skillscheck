...
// Create a function called 'oddChecker' that takes in one parameter, 'num'. Your function should check to see 
// if the parameter is even or odd. If the parameter is odd, return 'the number is odd'. If the number is even, return
//  'the number is even'.
...
//  and check to see if the number in the array is GREATER than 100. If it is,
//  push 'big' as a string to the answers array. If the number is LESS than or EQUAL to 100,
